...
\begin{itemize}
  \item Escribir el script de fusión de datasets y la conversión de bounding boxes a polígonos rectangulares para entrenar segmentación, en una exploración individual previa de Michael Lata sobre un dataset propio.
